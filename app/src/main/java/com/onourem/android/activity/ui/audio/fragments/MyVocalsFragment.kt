...
class MyVocalsFragment :
    ...
    companion object {
        fun create(): MyVocalsFragment {
            return MyVocalsFragment()
        }
    }
                                    ...
                                    coroutineScope.launch {
                                        withContext(Dispatchers.Main) {
                                            handlePermissionResultForUpSideDownCake(
                                                item.second,
                                                PermissionManager.requestPermissions(
                                                    this@MyVocalsFragment, MY_PERMISSIONS_REQUEST_MEDIA_PLAYBACK,
...
//                                )
        ...
        binding.rvAudioGames.addOnScrollListener(object : PaginationListener(layoutManager!!) {
            ...
            override fun isLastPage(): Boolean {
                return this@MyVocalsFragment.isLastPagePagination
            }

            override fun isLoading(): Boolean {
                return this@MyVocalsFragment.isLoadingPage
            }
        })
            ...
            if (apiResponse.loading) {
                ...
                if (apiResponse.body.errorCode.equals("000", ignoreCase = true)) {
                    ...
                    if (selectPrivacyViewModel!!.selectedPrivacyMutableLiveData!!
                        ...
                        this@MyVocalsFragment.privacyGroupsDefault.clear()
                        this@MyVocalsFragment.privacyGroupsDefault.addAll(
                            oldSelectedAfterResponse
                        )
                        this@MyVocalsFragment.privacyGroups.clear()
                        if (privacyGroups != null) {
                            this@MyVocalsFragment.privacyGroups.addAll(privacyGroups)
                        }
                        ...
                        this@MyVocalsFragment.privacyGroupsDefault.clear()
                        this@MyVocalsFragment.privacyGroupsDefault.addAll(defaultSelected)
                        this@MyVocalsFragment.privacyGroups.clear()
                        if (privacyGroups != null) {
                            this@MyVocalsFragment.privacyGroups.addAll(privacyGroups)
                        }
                    ...
                    navController.navigate(
                        MobileNavigationDirections.actionGlobalNavAudioPrivacy(
                            this@MyVocalsFragment.privacyGroups.toTypedArray(),
                            this@MyVocalsFragment.privacyGroupsDefault.toTypedArray(), song
                        )
                    )
                } else {
                    showAlert(apiResponse.body.errorMessage)

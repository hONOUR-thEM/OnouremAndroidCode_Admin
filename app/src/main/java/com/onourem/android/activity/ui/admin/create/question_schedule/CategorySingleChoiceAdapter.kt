...
class CategorySingleChoiceAdapter(
    private val context: Context,
    private var surveyOptions: ArrayList<CategoryList>
) : RecyclerView.Adapter<CategorySingleChoiceAdapter.SingleViewHolder>() {
    // if checkedPosition = -1, there is no default selection
    // if checkedPosition = 0, 1st item is selected by default
    private var checkedPosition = -1
    fun setSurveyOptions(surveyOptions: ArrayList<CategoryList>) {
    ...
    inner class SingleViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(surveyOption: CategoryList) {
            ...
            textView.text = surveyOption.catCode

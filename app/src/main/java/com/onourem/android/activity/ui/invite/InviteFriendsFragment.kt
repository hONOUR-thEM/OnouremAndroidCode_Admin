...
import com.onourem.android.activity.databinding.FragmentInviteFriendsBinding
...
class InviteFriendsFragment :
    AbstractBaseViewModelBindingFragment<QuestionGamesViewModel, FragmentInviteFriendsBinding>() {

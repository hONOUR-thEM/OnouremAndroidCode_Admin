...
import com.onourem.android.activity.ui.audio.adapters.MyVocalsAdapter
...
//    private var otherVocalsData: OtherVocalsData? = null
    ...
    private var songAdapter: MyVocalsAdapter? = null
    ...
    companion object {
        fun create(): ProfileMyVocalsFragment {
            return ProfileMyVocalsFragment()
        }
    }
...
//            }
        ...
        userActionViewModel!!.actionMutableLiveDataMyVocals.observe(viewLifecycleOwner) { action: Action<Any?>? ->
            if (action != null && action.actionType != ActionType.DISMISS) {
                userActionViewModel!!.actionConsumedMyVocals()
                        ...
                        withContext(Dispatchers.Main) {
                            handlePermissionResult(
                                PermissionManager.requestPermissions(
                                    this@ProfileMyVocalsFragment, 5,
...
//        }
    ...
    private fun loadData() {
        ...
        getAudioShorts(Constants.MY_VOCALS)
...
//            )
    ...
    private fun setAdapter() {
        ...
        if (songAdapter == null) {
            songAdapter =
                MyVocalsAdapter(songsFromServer, preferenceHelper) { item ->
...
//                                )
                                    ...
                                    coroutineScope.launch {
                                        withContext(Dispatchers.Main) {
                                            handlePermissionResultForUpSideDownCake(
                                                item.second,
                                                PermissionManager.requestPermissions(
                                                    this@ProfileMyVocalsFragment, MY_PERMISSIONS_REQUEST_MEDIA_PLAYBACK,
        ...
        binding.rvAudioGames.addOnScrollListener(object : PaginationListener(layoutManager!!) {
            ...
            override fun isLastPage(): Boolean {
                return this@ProfileMyVocalsFragment.isLastPagePagination
            }

            override fun isLoading(): Boolean {
                return this@ProfileMyVocalsFragment.isLoadingPage
            }
        })
            ...
            if (apiResponse.loading) {
                ...
                if (apiResponse.body.errorCode.equals("000", ignoreCase = true)) {
                    ...
                    if (selectPrivacyViewModel!!.selectedPrivacyMutableLiveData!!
                        ...
                        this@ProfileMyVocalsFragment.privacyGroupsDefault.clear()
                        this@ProfileMyVocalsFragment.privacyGroupsDefault.addAll(
                            oldSelectedAfterResponse
                        )
                        this@ProfileMyVocalsFragment.privacyGroups.clear()
                        if (privacyGroups != null) {
                            this@ProfileMyVocalsFragment.privacyGroups.addAll(privacyGroups)
                        }
                        ...
                        this@ProfileMyVocalsFragment.privacyGroupsDefault.clear()
                        this@ProfileMyVocalsFragment.privacyGroupsDefault.addAll(defaultSelected)
                        this@ProfileMyVocalsFragment.privacyGroups.clear()
                        if (privacyGroups != null) {
                            this@ProfileMyVocalsFragment.privacyGroups.addAll(privacyGroups)
                        }
                    ...
                    navController.navigate(
                        MobileNavigationDirections.actionGlobalNavAudioPrivacy(
                            this@ProfileMyVocalsFragment.privacyGroups.toTypedArray(),
                            this@ProfileMyVocalsFragment.privacyGroupsDefault.toTypedArray(), song
                        )
                    )
                } else {
                    showAlert(apiResponse.body.errorMessage)

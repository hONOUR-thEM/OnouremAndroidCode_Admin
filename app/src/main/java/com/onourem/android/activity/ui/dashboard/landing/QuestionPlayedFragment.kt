...
class QuestionPlayedFragment(val rvScrollListener: RVScrollListener?) :
    ...
    companion object {
        ...
        fun create(rvScrollListener: RVScrollListener): QuestionPlayedFragment {
            return QuestionPlayedFragment(rvScrollListener)
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        dashboardData = (fragmentContext as DashboardActivity).getDashboardDataAnswered()
...
//        }
        ...
        binding.rvPlayGames.addOnScrollListener(object : PaginationListener(layoutManager!!) {
            override fun loadMoreItems() {
                QuestionPlayedFragment.isLoading = true
                loadMoreGames()
            }

            override fun isLastPage(): Boolean {
                return QuestionPlayedFragment.isLastPage
            }

            override fun isLoading(): Boolean {
                return QuestionPlayedFragment.isLoading
            }
        })
        ...
        binding.swipeRefreshLayout.setOnRefreshListener {
            ...
            if (dashboardData != null) {
                (fragmentContext as DashboardActivity).setDashboardDataAnswered(null)
            }
            refreshUI()
        }
...
//                        0
//                    )
//                    (fragmentContext as DashboardActivity).setDashboardDataAnswered(dashboardData)
...
//            }
        ...
        if ((fragmentContext as DashboardActivity).getDashboardRecyclerViewPositionAnswered() != -1) layoutManager!!.scrollToPositionWithOffset(
            (fragmentContext as DashboardActivity).getDashboardRecyclerViewPositionAnswered(),
            (fragmentContext as DashboardActivity).getDashboardRecyclerViewPositionTopViewAnswered()
        )
...
//                                0
//                            )
//                            (fragmentContext as DashboardActivity).setDashboardDataAnswered(
//                                dashboardData
//                            )
...
//        counter++;
        ...
        (fragmentContext as DashboardActivity).setDashboardRecyclerViewPositionAnswered(
            positionIndex,
            topView
        )

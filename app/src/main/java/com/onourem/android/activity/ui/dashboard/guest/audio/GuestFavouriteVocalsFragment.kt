...
class GuestFavouriteVocalsFragment :
    ...
    companion object {
        fun create(): GuestFavouriteVocalsFragment {
            return GuestFavouriteVocalsFragment()
        }
    }
    ...
    private fun setAdapter() {
        ...
        binding.rvAudioGames.addOnScrollListener(object : PaginationListener(layoutManager!!) {
            ...
            override fun isLastPage(): Boolean {
                return this@GuestFavouriteVocalsFragment.isLastPagePagination
            }

            override fun isLoading(): Boolean {
                return this@GuestFavouriteVocalsFragment.isLoadingPage
            }
        })

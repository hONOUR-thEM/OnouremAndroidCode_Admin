...
class GuestMyVocalsFragment :
    ...
    companion object {
        fun create(): GuestMyVocalsFragment {
            return GuestMyVocalsFragment()
        }
    }
    ...
    private fun setAdapter() {
        ...
        binding.rvAudioGames.addOnScrollListener(object : PaginationListener(layoutManager!!) {
            ...
            override fun isLastPage(): Boolean {
                return this@GuestMyVocalsFragment.isLastPagePagination
            }

            override fun isLoading(): Boolean {
                return this@GuestMyVocalsFragment.isLoadingPage
            }
        })

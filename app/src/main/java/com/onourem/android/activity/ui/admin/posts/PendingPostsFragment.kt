...
class PendingPostsFragment :
    ...
    companion object {
        fun create(): PendingPostsFragment {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding!!.rvPosts.addOnScrollListener(object :
            ...
            override fun loadMoreItems() {
                this@PendingPostsFragment.isLoadingPage = true
                loadMorePosts()
            }

            override fun isLastPage(): Boolean {
                return this@PendingPostsFragment.isLastPagePagination
            }

            override fun isLoading(): Boolean {
                return this@PendingPostsFragment.isLoadingPage
            }
        })
...
//                    )
    ...
    private fun loadMorePosts() {
        if (feedIdsList == null || feedIdsList!!.isEmpty()) {
            this@PendingPostsFragment.isLastPagePagination = true
            this@PendingPostsFragment.isLoadingPage = false
            setFooterMessage()
            return
        }

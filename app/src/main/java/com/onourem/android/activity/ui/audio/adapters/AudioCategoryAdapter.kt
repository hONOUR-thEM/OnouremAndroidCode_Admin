...
class AudioCategoryAdapter(
    private val audioInfoList: ArrayList<AudioCategory>,
    private val onItemClickListener: OnItemClickListener<AudioCategory>?,
) : RecyclerView.Adapter<AudioCategoryAdapter.AudioGamesViewHolder>() {
    ...
    inner class AudioGamesViewHolder(view: View?) : RecyclerView.ViewHolder(
        ...
        fun bind(category: AudioCategory) {

            rowBinding!!.tvName.text = category.name

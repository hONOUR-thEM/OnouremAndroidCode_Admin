...
class MyOwnQuestionsFragment() :
    ...
    companion object {
        ...
        fun create(): MyOwnQuestionsFragment {
            return MyOwnQuestionsFragment()
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvPlayGames.addOnScrollListener(object : PaginationListener(layoutManager!!) {
            override fun loadMoreItems() {
                MyOwnQuestionsFragment.isLoading = true
                loadMoreGames()
            }

            override fun isLastPage(): Boolean {
                return MyOwnQuestionsFragment.isLastPage
            }

            override fun isLoading(): Boolean {
                return MyOwnQuestionsFragment.isLoading
            }
        })
...
//        })
    ...
    private fun editQuestion(action: Action<Any?>?) {
        ...
        navController.navigate(MyOwnQuestionsFragmentDirections.actionNavMyQuestionsToNavEditQuestion(first))
    }
...
//                        }
    ...
    private fun navigateToDetails(item: LoginDayActivityInfoList?, playGroup: PlayGroup?) {
        ...
        if (navController.currentDestination!!.id == R.id.nav_my_questions && item != null) {
            navController.navigate(

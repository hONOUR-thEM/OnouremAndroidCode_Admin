...
class ActivityExternalDetailsAdapter(
        ...
        override fun onBind(position: Int) {
            ...
            itemBinding.txtQuestionFor.text =
                String.format(
                    ...
                    externalActivityData.id,
                    externalActivityData.activityType,
...
//            })
            ...
            itemBinding.btnAutoTriggerInOclub.setOnClickListener(ViewClickListener { v1: View? ->
                ...
                onItemClickListener.onItemClick(Triple(ActivityDetailsAdapter.CLICK_AUTO_TRIGGER_OCLUB, notificationItem, bindingAdapterPosition))
            })

            itemBinding.btnInactive.setOnClickListener(ViewClickListener { v1: View? ->
                val notificationItem = items[bindingAdapterPosition]
                onItemClickListener.onItemClick(Triple(ActivityDetailsAdapter.CLICK_IN_ACTIVE, notificationItem, bindingAdapterPosition))
            })

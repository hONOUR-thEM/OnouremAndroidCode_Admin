...
class OthersVocalsFragment :
    ...
    private lateinit var vocalUserId: String
    ...
    private var selectedFilterIndex = 4
    ...
    companion object {
        fun create(): OthersVocalsFragment {
            return OthersVocalsFragment()
        }
    }
...
//        counter++;
    ...
    private fun setAdapter() {
        ...
        if (songAdapter == null) {
            songAdapter =
                AudioGamesAdapter(songsFromServer, preferenceHelper) { item ->
                                    ...
                                    coroutineScope.launch {
                                        withContext(Dispatchers.Main) {
                                            handlePermissionResultForUpSideDownCake(
                                                item.second,
                                                PermissionManager.requestPermissions(
                                                    this@OthersVocalsFragment, MY_PERMISSIONS_REQUEST_MEDIA_PLAYBACK,
...
//                                navBuilder.setPopUpTo(R.id.nav_vocals_main, false).build()
        ...
        binding.rvAudioGames.addOnScrollListener(object : PaginationListener(layoutManager!!) {
            ...
            override fun isLastPage(): Boolean {
                return this@OthersVocalsFragment.isLastPagePagination
            }

            override fun isLoading(): Boolean {
                return this@OthersVocalsFragment.isLoadingPage
            }
        })
...
//                        )
            ...
            if (apiResponse.loading) {
                ...
                if (apiResponse.body.errorCode.equals("000", ignoreCase = true)) {
                    ...
                    if (selectPrivacyViewModel!!.selectedPrivacyMutableLiveData!!
                        ...
                        this@OthersVocalsFragment.privacyGroupsDefault.clear()
                        this@OthersVocalsFragment.privacyGroupsDefault.addAll(
                            oldSelectedAfterResponse
                        )
                        this@OthersVocalsFragment.privacyGroups.clear()
                        if (privacyGroups != null) {
                            this@OthersVocalsFragment.privacyGroups.addAll(privacyGroups)
                        }
                        ...
                        this@OthersVocalsFragment.privacyGroupsDefault.clear()
                        this@OthersVocalsFragment.privacyGroupsDefault.addAll(defaultSelected)
                        this@OthersVocalsFragment.privacyGroups.clear()
                        if (privacyGroups != null) {
                            this@OthersVocalsFragment.privacyGroups.addAll(privacyGroups)
                        }
                    ...
                    navController.navigate(
                        MobileNavigationDirections.actionGlobalNavAudioPrivacy(
                            this@OthersVocalsFragment.privacyGroups.toTypedArray(),
                            this@OthersVocalsFragment.privacyGroupsDefault.toTypedArray(), song
                        )
                    )
                } else {
                    showAlert(apiResponse.body.errorMessage)
    ...
    private fun getAudioShorts(service: String) {
        ...
        AppUtilities.showLog(
            "Link", "LinkType :Audio API: getAudioInfo | sent LinkUserId = $linkUserId"
        )
        isLastPagePagination = false
        isDataLoading = true
...
//                binding.songTitle.visibility = View.VISIBLE
    ...
    override fun onDestroy() {
        ...
        dashboardViewModel!!.setShowVocalsFragment(true)
        super.onDestroy()
    }

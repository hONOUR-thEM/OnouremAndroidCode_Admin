...
class GuestMyQuestionsFragment(val rvScrollListener: RVScrollListener) :
    ...
    companion object {
        ...
        fun create(rvScrollListener: RVScrollListener): GuestMyQuestionsFragment {
            return GuestMyQuestionsFragment(rvScrollListener)
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvPlayGames.addOnScrollListener(object : PaginationListener(layoutManager!!) {
            override fun loadMoreItems() {
                GuestMyQuestionsFragment.isLoading = true
                //loadMoreGames()
            }

            override fun isLastPage(): Boolean {
                return GuestMyQuestionsFragment.isLastPage
            }

            override fun isLoading(): Boolean {
                return GuestMyQuestionsFragment.isLoading
            }
        })

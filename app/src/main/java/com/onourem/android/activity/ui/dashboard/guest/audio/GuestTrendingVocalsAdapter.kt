...
import com.onourem.android.activity.databinding.ItemAudioGuestBinding
...
class GuestTrendingVocalsAdapter(
    items: List<Song>,
    ...
    override fun onCreateItemViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
        return AudioGamesItemViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.item_audio_guest, parent, false)
        )
    }
    ...
    internal inner class AudioGamesItemViewHolder(itemView: View) : BaseViewHolder(itemView) {
        private val rowBinding: ItemAudioGuestBinding = ItemAudioGuestBinding.bind(itemView)
...
//            if (song.audioStatus != null && song.audioStatus == "Active" && preferenceHelper.getString(Constants.KEY_SELECTED_FILTER_INT) == "2") {
...
//            }
    ...
    fun animateChange(viewHolder: ItemAudioGuestBinding) {
        val colorFrom: Int =

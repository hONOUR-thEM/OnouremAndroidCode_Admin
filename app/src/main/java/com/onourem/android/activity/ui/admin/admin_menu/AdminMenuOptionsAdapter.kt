...
class AdminMenuOptionsAdapter(
    ...
    inner class AudioGamesViewHolder(view: View?) : RecyclerView.ViewHolder(view!!) {

        private val rowBinding: ItemAdminMenuOptionsBinding? = DataBindingUtil.bind(itemView)

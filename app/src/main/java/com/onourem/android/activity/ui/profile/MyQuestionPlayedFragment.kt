...
class MyQuestionPlayedFragment() :
    ...
    companion object {
        ...
        fun create(): MyQuestionPlayedFragment {
            return MyQuestionPlayedFragment()
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionGamesViewModel!!.actionOpenPlayGroupListing.observe(this) { action: Boolean ->
            if (action && isFrom.equals("solo", ignoreCase = true)) {
                ...
                if (id == R.id.nav_my_question_played) {
...
//        }
        ...
        binding.rvPlayGames.addOnScrollListener(object : PaginationListener(layoutManager!!) {
            override fun loadMoreItems() {
                MyQuestionPlayedFragment.isLoading = true
                loadMoreGames()
            }

            override fun isLastPage(): Boolean {
                return MyQuestionPlayedFragment.isLastPage
            }

            override fun isLoading(): Boolean {
                return MyQuestionPlayedFragment.isLoading
            }
        })
...
//        }
    ...
    private fun navigateToDetails(item: LoginDayActivityInfoList?, playGroup: PlayGroup?) {
        ...
        if (navController.currentDestination!!.id == R.id.nav_my_question_played && item != null) {
            navController.navigate(

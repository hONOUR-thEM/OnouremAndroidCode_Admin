...
import com.onourem.android.activity.ui.audio.adapters.FriendsVocalsAdapter
...
class FriendsVocalsFragment :
    ...
    private var songAdapter: FriendsVocalsAdapter? = null
    ...
    companion object {
        fun create(): FriendsVocalsFragment {
            return FriendsVocalsFragment()
        }
    }
...
//                            it))
        ...
        userActionViewModel!!.actionMutableLiveDataFriends.observe(viewLifecycleOwner) { action: Action<Any?>? ->
            if (action != null && action.actionType != ActionType.DISMISS) {
                userActionViewModel!!.actionConsumedFriends()
...
//                            Manifest.permission.READ_CONTACTS,
    ...
    private fun loadData() {
        ...
        getAudioShorts(Constants.FRIENDS_VOCALS)
...
//        counter++;
    ...
    private fun setAdapter() {
        ...
        if (songAdapter == null) {
            songAdapter =
                FriendsVocalsAdapter(songsFromServer, preferenceHelper) { item ->
...
//                                )
                                    ...
                                    coroutineScope.launch {
                                        withContext(Dispatchers.Main) {
                                            handlePermissionResultForUpSideDownCake(
                                                item.second,
                                                PermissionManager.requestPermissions(
                                                    this@FriendsVocalsFragment, MY_PERMISSIONS_REQUEST_MEDIA_PLAYBACK,
        ...
        binding.rvAudioGames.addOnScrollListener(object : PaginationListener(layoutManager!!) {
            ...
            override fun isLastPage(): Boolean {
                return this@FriendsVocalsFragment.isLastPagePagination
            }

            override fun isLoading(): Boolean {
                return this@FriendsVocalsFragment.isLoadingPage
            }
        })
            ...
            if (apiResponse.loading) {
                ...
                if (apiResponse.body.errorCode.equals("000", ignoreCase = true)) {
                    ...
                    if (selectPrivacyViewModel!!.selectedPrivacyMutableLiveData!!
                        ...
                        this@FriendsVocalsFragment.privacyGroupsDefault.clear()
                        this@FriendsVocalsFragment.privacyGroupsDefault.addAll(
                            oldSelectedAfterResponse
                        )
                        this@FriendsVocalsFragment.privacyGroups.clear()
                        if (privacyGroups != null) {
                            this@FriendsVocalsFragment.privacyGroups.addAll(privacyGroups)
                        }
                        ...
                        this@FriendsVocalsFragment.privacyGroupsDefault.clear()
                        this@FriendsVocalsFragment.privacyGroupsDefault.addAll(defaultSelected)
                        this@FriendsVocalsFragment.privacyGroups.clear()
                        if (privacyGroups != null) {
                            this@FriendsVocalsFragment.privacyGroups.addAll(privacyGroups)
                        }
                    ...
                    navController.navigate(
                        MobileNavigationDirections.actionGlobalNavAudioPrivacy(
                            this@FriendsVocalsFragment.privacyGroups.toTypedArray(),
                            this@FriendsVocalsFragment.privacyGroupsDefault.toTypedArray(), song
                        )
                    )
                } else {
                    showAlert(apiResponse.body.errorMessage)

...
class SingleChoiceCategoryAdapter(
    private val context: Context,
    private val alertDialog: AlertDialog,
    private var categoryList: ArrayList<PlayGroupCategoryList>?,
    private val onItemClickListener: OnItemClickListener<PlayGroupCategoryList?>?
) : RecyclerView.Adapter<SingleChoiceCategoryAdapter.SingleViewHolder>() {
    // if checkedPosition = -1, there is no default selection
    // if checkedPosition = 0, 1st item is selected by default
    private var checkedPosition = -1
    @SuppressLint("NotifyDataSetChanged")
    fun setCategoryList(categoryList: ArrayList<PlayGroupCategoryList>?) {
    ...
    val selected: PlayGroupCategoryList?
    ...
    inner class SingleViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(surveyOption: PlayGroupCategoryList) {
            ...
            textView.text = surveyOption.categoryName

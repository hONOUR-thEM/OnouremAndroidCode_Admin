...
class AdminVocalsFragment() :
    ...
    companion object {
        fun create(): AdminVocalsFragment {
            return AdminVocalsFragment()
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        vocalUserId = AdminVocalsFragmentArgs.fromBundle(requireArguments()).vocalUserId
        linkUserId = AdminVocalsFragmentArgs.fromBundle(requireArguments()).linkUserId
        now = Calendar.getInstance()

        audioIdFromNotification =
            AdminVocalsFragmentArgs.fromBundle(requireArguments()).audioIdFromNotification
...
//                            it))
        ...
        binding.rvAudioGames.addOnScrollListener(object : PaginationListener(layoutManager!!) {
            ...
            override fun isLastPage(): Boolean {
                return this@AdminVocalsFragment.isLastPagePagination
            }

            override fun isLoading(): Boolean {
                return this@AdminVocalsFragment.isLoadingPage
            }
        })
            ...
            if (apiResponse.loading) {
                ...
                if (apiResponse.body.errorCode.equals("000", ignoreCase = true)) {
                    ...
                    if (selectPrivacyViewModel.selectedPrivacyMutableLiveData
                        ...
                        this@AdminVocalsFragment.privacyGroupsDefault.clear()
                        this@AdminVocalsFragment.privacyGroupsDefault.addAll(
                            oldSelectedAfterResponse
                        )
                        this@AdminVocalsFragment.privacyGroups.clear()
                        this@AdminVocalsFragment.privacyGroups.addAll(privacyGroups)
                        ...
                        this@AdminVocalsFragment.privacyGroupsDefault.clear()
                        this@AdminVocalsFragment.privacyGroupsDefault.addAll(defaultSelected)
                        this@AdminVocalsFragment.privacyGroups.clear()
                        this@AdminVocalsFragment.privacyGroups.addAll(privacyGroups)
                        //viewModel.setSelectedPrivacyGroup(privacyGroupsDefault)
                    }
                    ...
                    navController.navigate(
                        MobileNavigationDirections.actionGlobalNavAudioPrivacy(
                            this@AdminVocalsFragment.privacyGroups.toTypedArray(),
                            this@AdminVocalsFragment.privacyGroupsDefault.toTypedArray(), song
                        )
                    )
                } else {
                    showAlert(apiResponse.body.errorMessage)

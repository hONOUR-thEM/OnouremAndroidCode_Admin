...
class TaskAndMessageViewModel @Inject constructor(
    ...
    override fun getTaskAndMessageGameActivityRes(activityId: String?): LiveData<ApiResponse<TaskAndMessageGameActivityResResponse>> {
        return taskAndMessageRepository.getTaskAndMessageGameActivityRes(activityId)
    }
    ...
    override fun getTaskMessageForPlaygroup(
        ...
        return taskAndMessageRepository.getTaskMessageForPlaygroup(activityId, oclubActivityId, playgroupId)
    }
    ...
    override fun getUserActivityAndGameInfo(
        ...
        return taskAndMessageRepository.getUserActivityAndGameInfo(activityId, profileUserId)
    }

package com.onourem.android.activity.ui.admin.vocals.ratingbar;
...
public class BaseRatingBar extends LinearLayout implements OnouremRatingBar {
    ...
    private void verifyParamsValue() {
        ...
        if (mEmptyDrawable == null) {
            mEmptyDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_empty_star);
        }

        if (mFilledDrawable == null) {
            mFilledDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_filled_star);
        }

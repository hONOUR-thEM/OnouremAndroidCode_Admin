...
class RejectedPostsFragment :
    ...
    companion object {
        fun create(): RejectedPostsFragment {
            return RejectedPostsFragment()
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding!!.rvPosts.addOnScrollListener(object :
            ...
            override fun loadMoreItems() {
                this@RejectedPostsFragment.isLoadingPage = true
                loadMorePosts()
            }

            override fun isLastPage(): Boolean {
                return this@RejectedPostsFragment.isLastPagePagination
            }

            override fun isLoading(): Boolean {
                return this@RejectedPostsFragment.isLoadingPage
            }
        })
...
//                }
    ...
    private fun loadMorePosts() {
        if (feedIdsList == null || feedIdsList!!.isEmpty()) {
            this@RejectedPostsFragment.isLastPagePagination = true
            this@RejectedPostsFragment.isLoadingPage = false
            setFooterMessage()
            return
        }

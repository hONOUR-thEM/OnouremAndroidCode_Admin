...
class GetUserProfileDataResponse {
    ...
    @Expose
    internal var feedsList: List<Any>? = null

    @SerializedName("feedActionDataList")
    @Expose
    internal var feedActionDataList: List<Any>? = null
    ...
    @Expose
    internal var userProfileData: UserProfileData? = null
    ...
    fun getFeedsList(): List<Any>? {
        return feedsList
    }

    fun setFeedsList(feedsList: List<Any>?) {
        this.feedsList = feedsList
    }

    fun getFeedActionDataList(): List<Any>? {
        return feedActionDataList
    }

    fun setFeedActionDataList(feedActionDataList: List<Any>?) {
    ...
    fun setUserProfileData(userProfileData: UserProfileData?) {

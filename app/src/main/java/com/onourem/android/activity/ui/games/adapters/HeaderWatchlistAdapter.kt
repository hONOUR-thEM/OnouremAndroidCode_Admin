...
class HeaderWatchlistAdapter(val title: String, val titleSub: String, val drawable: Drawable) :
    RecyclerView.Adapter<HeaderWatchlistAdapter.HeaderViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HeaderViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.watchlist_header_item, parent, false)

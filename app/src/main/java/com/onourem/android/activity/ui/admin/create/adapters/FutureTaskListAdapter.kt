...
internal class FutureTaskListAdapter(
    ...
    internal inner class SingleViewHolder(itemView: View) : BaseViewHolder(itemView) {
        ...
        override fun onBind(position: Int) {
            ...
            itemBinding.txtDate.text = if (adminActivityResponse.activityTriggered) {
                "Triggered On ${getServerTimeConversation(adminActivityResponse.scheduledTime!!)}"
            } else if (adminActivityResponse.activityScheduled) {
                "Scheduled For ${getServerTimeConversation(adminActivityResponse.scheduledTime!!)}"
            } else {
                "Created On  ${getServerTimeConversation(adminActivityResponse.createdTime!!)}"
            }
